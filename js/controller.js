...
//                                     alert(JSON.stringify(data));
                   ...
                   $scope.success = function(){
                    ...
                    if(successurl=='http://nuatransmedia.com/song_app/stripe/done.html'){
                   ...
                   //  alert('hi');
                   //  alert(this.location);
                   //                      if(this.location=='http://nuatransmedia.com/song_app/stripe/done.html/'){
                   //                      ref.close();
                   ...
                   ref.addEventListener('loadstop', function(event) {
                                        ...
                                        ref.close();
                                        var res = url.replace(/&/g, "^");
                                        console.log('http://nuatransmedia.com/song_app/stripe/cart_details.php?url='+res);
                                        $scope.payment_success('http://nuatransmedia.com/song_app/stripe/cart_details.php?url='+res);
                                        }
                                        });
                   }
